...
internal class Lesson6
{
    ...
    /*
     ...
     in the method affects the called value.
     */
    ...
    /*
     The out parameter modifier is passed by reference. The out variable
     passed in does not have to be initialized.
     */
    ...
    {
        anotherHat($"I tried on a {type} hat at {++oldSize}");
    }
